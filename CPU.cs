...
namespace MakePC
{
    class CPU : Database
    {
        ...
        public CPU(int id, string p1, string p2, string p3, string p4, string p5, string p6, string p7, string p8, int p9)
        {
            this.id = id;
            this.p1 = p1;
            this.p2 = p2;
        ...
        public void insertCPU(string p1, string p2, string p3, string p4, string p5, string p6, string p7, string p8, int p9)
        {
            command.CommandText = "INSERT INTO cpu (p1, p2, p3, p4, p5, p6, p7, p8, p9) VALUES('" + p1 + "','" + p2 + "','" + p3 + "','" + p4 + "','" + p5 + "','" + p6 + "','" + p7 + "','" + p8 + "','" + p9 + "')";
        ...
        public List<CPU> selectCPU()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    cpu.Add(new CPU(Convert.ToInt32(reader["id"]),
