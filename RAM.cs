...
namespace MakePC
{
    class RAM : Database
    {
        ...
        public RAM(int id, string p1, string p2, string p3, string p4, string p5, string p6, string p7, string p8, int p9)
        {
            this.id = id;
            this.p1 = p1;
            this.p2 = p2;
        ...
        public void insertRAM(string p1, string p2, string p3, string p4, string p5, string p6, string p7, string p8, int p9)
        {
            command.CommandText = "INSERT INTO ram (p1, p2, p3, p4, p5, p6, p7, p8, p9) VALUES('" + p1 + "','" + p2 + "','" + p3 + "','" + p4 + "','" + p5 + "','" + p6 + "','" + p7 + "','" + p8 + "','" + p9 + "')";
        ...
        public List<RAM> selectRAM()
        {
            ...
            try
            {
                ...
                while (reader.Read())
                {
                    ram.Add(new RAM(Convert.ToInt32(reader["id"]),
